...
[ $\alpha = x$ and $x^{2} \equiv x + 1 \mod x^{2} + x + 1$ and $x = 2$ then $x + (x + 1) = 2x + 1 = 1 \in F_{2}[x]$ ].

[ $\alpha^{3} = x^{3} = xx^{2} \equiv x(x + 1) \equiv x^{2} + x \equiv 2x + 1 \equiv 1 \mod x^{2} + x + 1 \in F_{2}[x]$ ].
